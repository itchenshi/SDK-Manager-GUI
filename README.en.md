...
3. **Automatic Environment Variable Configuration** — Automatically configures PATH and language-specific environment variables (NODE_HOME / JAVA_HOME / PYTHON_HOME / MAVEN_HOME) after installation, supporting both user-level and system-level
...
|-----|--------|----------------------|----------------------|----------------------|
| **Node.js** | nodejs.org / Taobao Mirror | LTS / Current | NODE_HOME, PATH | npm mirror configuration |
| **Java (Eclipse Temurin)** | Adoptium API | LTS labels (JDK 8/11/17/21) | JAVA_HOME, PATH | — |
| **Python** | python.org / Mirror | Embedded version | PYTHON_HOME, PATH | pip mirror configuration (get-pip.py auto-setup) |
| **Maven** | Apache Official / Mirror | — | MAVEN_HOME, PATH | Dependency mirror (settings.xml), local repository (localRepository) |
